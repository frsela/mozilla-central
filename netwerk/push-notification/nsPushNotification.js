...
const kDB_UA_STORE_NAME = "ua-registration";
const kDB_WA_STORE_NAME = "wa-registrations";
 ...
 * service.  Applications start push-notification by registering with
 * nsPushNotification for him-self.  The applicaton will receive a
...
nsPushNotification.prototype = {
  ...
  recallWAURL: function recallWAInternal(pushURL, callback) {
