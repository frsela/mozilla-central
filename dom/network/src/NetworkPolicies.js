...
function NetworkPolicies(aProp) { debug("NetworkPolicies Constructor"); }

NetworkPolicies.prototype = {
...
*/
  ...
  QueryInterface : XPCOMUtils.generateQI([nsIDOMMozNetworkPolicies, Ci.nsIDOMGlobalPropertyInitializer])
}
